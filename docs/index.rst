...
.. list-table::
   ...
   * - .. figure:: _static/images/codes.png
          ...
          :align: center
          :width: 250px
          :target: https://deltakit.readthedocs.io/en/stable/api.html#deltakit-explorer-codes

     - .. figure:: _static/images/qpu_noise.png
          :alt: QPU and noise analysis
          :align: center
          :width: 250px
          :target: https://deltakit.readthedocs.io/en/stable/api.html#deltakit-explorer-qpu

   * - .. figure:: _static/images/experiments.png
          :alt: Experiments
          :align: center
          :width: 250px
          :target: https://deltakit.readthedocs.io/en/stable/api.html#deltakit-explorer

     - .. figure:: _static/images/decoders.png
          :alt: Decoders
          :align: center
          :width: 250px
          :target: https://deltakit.readthedocs.io/en/stable/api.html#deltakit-decode
